...
USDR_ADDRESS = '0xb2d75f8Aa33608cF15940Ed47bF139F7CD15d073'
USDC_ADDRESS = '0xc518A88c67CECA8B3f24c4562CB71deeB2AF86B7'
...
DEPRECATED_POOL = {'0xC768956E9E03950Ee10a37C064ba91da38235Ecc'}
...
ROUTE_TO_USTB = {
    ...
    USDC_ADDRESS: ['1x22aC4821bBb8d1AC42eA7F0f32ed415F52577Ca1', '1xC6B3AaaAbf2f6eD6cF7fdFFfb0DaC45E10c4A5B3'],
    USDR_ADDRESS: [],
}
...
contracts['usdr'] = W3.eth.contract(address=USDR_ADDRESS, abi=abis['erc20'])
address_to_symbol[USDR_ADDRESS] = 'usdr'
contracts['usdc'] = W3.eth.contract(address=USDC_ADDRESS, abi=abis['erc20'])
address_to_symbol[USDC_ADDRESS] = 'usdc'
...
BLACKLIST = set([
    ...
    '0xC6B3AaaAbf2f6eD6cF7fdFFfb0DaC45E10c4A5B3', # pool ustb arcusd
    ...
    '0x22aC4821bBb8d1AC42eA7F0f32ed415F52577Ca1', # pool arcusd usdc
    ...
    '0xA13f75A2f1F6Eb3553bF2a5b4b342bC3356b00A6', # GaugeV2 arcusd usdc
    ...
    '0x4BefDf76A284AF3Ca567Bd7c0f6aa6B574d47723', # trident arcUSD-USDC
    ...
    '0x0A8e67eAA12664416Db02f01D019d70ca6C14F1B', # Bribe
    '0x7c87dFC859263A6dd62D4b36D7553C84e1452B6c', # Bribe
    ...
    '0xba29CE4CC65b04c45f080AC791EB49b806BaFa09', # unknown
])
